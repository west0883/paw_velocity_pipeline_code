...
parameters.input_filename = {[parameters.dir_exper 'behavior\body\normalized with zscore\paw velocity normalized with total magnitude\'], 'mouse', '\', 'day', '\', 'velocity', 'stack', '.mat'};
...
parameters.output_directory_position =  {[parameters.dir_exper 'behavior\body\normalized with zscore\paw position normalized with total magnitude\'], 'mouse', '\', 'day', '\'};
